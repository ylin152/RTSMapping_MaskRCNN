...
Model validation based on AP during training
"""
...
@torch.no_grad()
def evaluate(model, data_loader, device, mask_threshold=0.5):
    ...
    for images, targets in metric_logger.log_every(data_loader, 100, header):
        ...
        coco_evaluator.update(res, mask_threshold=mask_threshold)
